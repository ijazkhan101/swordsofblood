...
export default function Strings() {
  return {
    ...
    presaleStage: "PRESALE 1 IS OFFICIALLY OPEN",

    // buyBeforeTheEnd: "Hurry before the end of presale!",
    buyBeforeTheEnd: "Please wait for announcements",
    buyBefore: "Hurry before Presale 2 price increases to",
    soldTtl: "Sold",
    raisedTtl: "Raised",
    ...
    whybuyToken4: "2-year comprehensive plan for game dev expansion and user acquisition",
    ...
    wygTitle3: "4.5 out of 5-star average user ratings",
    ...
    modeT6: "Campaign",
    modeInfo: "Swords of Blood’s MVP features multiple game modes! Get exclusive access to the closed beta (launching in May) when you participate in the ongoing",
